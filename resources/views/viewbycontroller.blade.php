<h1>View by Controller</h1>
<h2>The name is: {{ $name ?? 'No name provided' }}</h2>
<p>This is the view by controller page dynamically generated from the route parameters {name} in the URL</p>
